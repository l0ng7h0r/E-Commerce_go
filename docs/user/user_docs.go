                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/domain.AddCartItemReq"
                        }
                    }
                ],
                "responses": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/domain.UpdateCartItemReq"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "in": "body",
                        "schema": {
                            "$ref": "#/definitions/domain.CreateOrderReq"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/domain.CreatePaymentReq"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "domain.CartItem": {
            ...
            "properties": {
                ...
                "product": {
                    "$ref": "#/definitions/domain.CartProduct"
                },
                "product_id": {
                    "type": "string"
                },
